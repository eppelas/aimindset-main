...
| Команды и non-profit | `src/pages/<page>/index.html`, `src/content/pages/<page>.json`; общая накидка редактора в `src/page/editor/` и `src/page/runtime/` |
| Юридические страницы | `tools/site-pages/` и страницы `oferta/`, `confpolicy/` |
